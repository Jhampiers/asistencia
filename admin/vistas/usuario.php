...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="email" name="email" id="email" maxlength="70" placeholder="correo">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Usuario:</label>
      <input class="form-control" type="text" name="user" id="user" maxlength="20" placeholder="nombre de usuario" required>
    </div>
